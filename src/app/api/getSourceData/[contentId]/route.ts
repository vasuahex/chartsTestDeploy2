...
export async function GET(req: any, contentId2: any) {
    console.log('called contentOd')
  ...
  const contentId = contentId2?.params?.contentId;
  console.log('contentId',contentId,contentId);
